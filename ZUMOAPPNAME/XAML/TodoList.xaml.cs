...
namespace K_Bikpower
{
    ...
    {
        Asset_Table_Manager manager;

        public TodoList()
        {
            InitializeComponent();

            manager = Asset_Table_Manager.DefaultManager;
        ...
        async Task CompleteItem(Assets item)
        {
            item.Done = true;
            await manager.SaveTaskAsync(item);
            todoList.ItemsSource = await manager.GetTodoItemsAsync();
        ...
        {
            var todo = new Assets { Name = newItemName.Text };
            await AddItem(todo);
        ...
        {
            var todo = e.SelectedItem as Assets;
        ...
        public async void OnComplete(object sender, EventArgs e)
        {
            ...
            var todo = mi.CommandParameter as Assets;
            await CompleteItem(todo);
        }
