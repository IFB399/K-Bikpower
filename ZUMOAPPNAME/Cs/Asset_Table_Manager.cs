...
{
    public partial class Asset_Table_Manager
    {
        static Asset_Table_Manager defaultInstance = new Asset_Table_Manager();
        ...
        public static Asset_Table_Manager DefaultManager
        {
            get
            {
